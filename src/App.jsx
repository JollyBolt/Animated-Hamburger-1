  ...
  return (
    <>
      ...
      <div className='h-[4rem] bg-slate-300'>
        ...
        <p className='text-xl mt-3'>View the source code on <a href='https://github.com/JollyBolt/Animated-Hamburger-1' className='underline font-bold'>Github</a> and star the repository. </p>
        </div>
      </div>
    </>
  )
